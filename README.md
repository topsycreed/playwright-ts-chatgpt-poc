# This is just demo project for self education for Playwright using ChatGPT
...
5. Create a .env file in the root of your project with CHATGPT_API_KEY and BASE_URL for your tested API
